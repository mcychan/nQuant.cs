...
function Header(props) {  
	return preact.createElement("div", {className: "container", style: {textAlign: "center"} },
		[
			preact.createElement("h2", {style: {paddingBottom: "1em"}}, preact.createElement("a", {key: "hDownload", name: "download", href: "#", onClick: props.onClick}, "ImgV64")),
...
function Tabs(props) {  
	...
	return preact.createElement("div", {className: "panel", style: {paddingBottom: "1em"}},
		[
			childrenData.map((item, index) => {
				return preact.createElement("a", {key: `link${index}`, name: item["id"], onClick: props.onClick, ...item["attrs"]},
