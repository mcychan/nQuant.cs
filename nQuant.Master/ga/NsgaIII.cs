...
namespace nQuant.Master.Ga
{
	...
	public class NsgaIII<T> where T : Chromosome<T>
	{
		...
		public NsgaIII(T prototype, int numberOfCrossoverPoints = 2, int mutationSize = 2, float crossoverProbability = 80, float mutationProbability = 3) : this(prototype, 9)
		{
			_criteriaLength = prototype.Objectives.Length;
		...
		public virtual void Run(int maxRepeat = 3, double minFitness = -Double.Epsilon)
		{
			if (_prototype == null)
				return;
